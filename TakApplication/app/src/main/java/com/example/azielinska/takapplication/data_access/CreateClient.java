 ...
 */
public class CreateClient extends AsyncTask<String,Void,String>
{
    private static final String URI = Config.SERVER_NAME+ "new_client.php";

    public boolean InsertClient(User u)
    {
        execute(new String[]{u.get_LName(),u.get_FName(),u.get_Username(), u.get_PhoneNo(),u.get_IsActive().toString(),u.get_AdressId().toString()});
        return true;
    }
    ...
    {       String result = "";
        ...
        try {
            ...
            String data= URLEncoder.encode("lname","UTF-8")+"="+URLEncoder.encode(lname,"UTF-8")+"&"+
                    ...
                    URLEncoder.encode("adress_id","UTF-8")+"="+URLEncoder.encode(adress_id,"UTF-8");
